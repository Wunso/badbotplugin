...
import net.runelite.osrsbb.launcher.Application;
import net.runelite.osrsbb.launcher.BadLite;
import net.runelite.osrsbb.launcher.BadLiteInterface;
...
public class BotViewPanel extends PluginPanel {
    ...
    public void paint(Graphics g) {
        BadLiteInterface[] bots = Application.getBots();
    ...
    public void draw(Graphics g, int idx, int x, int y, int width, int height) {
        BadLiteInterface[] bots = Application.getBots();
        BufferedImage img = ((BadLite) bots[idx]).getBackBuffer();
